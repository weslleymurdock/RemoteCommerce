        ...
        migrationBuilder.Sql("""
            ...
            BEGIN
                ...
                (
                    ...
                    PackagePath nvarchar(2048) NOT NULL,
                    State int NOT NULL,
                    DesiredState int NOT NULL,
                    PackageHash nvarchar(64) NOT NULL,
                    PendingVersion nvarchar(50) NULL,
            ...
            BEGIN
                ...
                (
                    ...
                    CONSTRAINT PK_PluginVersions PRIMARY KEY (Id)
                );
            ...
            BEGIN
                ...
                (
                    ...
                    MinimumVersion nvarchar(50) NOT NULL,
                    MaximumVersion nvarchar(50) NULL,
                    CONSTRAINT PK_PluginDependencies PRIMARY KEY (Id)
                );
            ...
            BEGIN
                ...
                (
                    ...
                    CONSTRAINT PK_PluginLifecycleErrors PRIMARY KEY (Id)
                );
            ...
            BEGIN
                ...
                (
                    ...
                    CONSTRAINT PK_PluginSettings PRIMARY KEY (Id)
                );
            ...
            SELECT NEWID(), PluginId, Version, PackagePath, PackageHash, InstalledAt, 1
            FROM commerce.PluginInstallations installation
            WHERE NOT EXISTS
            (
                SELECT 1 FROM commerce.PluginVersions version
                WHERE version.PluginId = installation.PluginId AND version.Version = installation.Version
            );
            """);
    }
