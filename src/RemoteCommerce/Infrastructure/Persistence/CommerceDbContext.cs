...
/// <summary>
/// Provides the EF Core persistence boundary for RemoteCommerce.
/// </summary>
...
{
    /// <summary>
    /// Gets the installed plugin records.
    /// </summary>
    public DbSet<PluginInstallation> PluginInstallations => Set<PluginInstallation>();

    /// <summary>
    /// Configures the relational model used by the commerce host.
    /// </summary>
