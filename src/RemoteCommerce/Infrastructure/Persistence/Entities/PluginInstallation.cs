...
public sealed class PluginInstallation : RemoteCommerce.Domain.Shared.Abstractions.ISoftDeletable
{
    ...
    /// <summary>Gets or sets whether the installation record has been soft-deleted.</summary>
    public bool IsDeleted { get; set; }

    /// <summary>Gets or sets the UTC timestamp at which the installation record was soft-deleted.</summary>
    public DateTimeOffset? DeletedAt { get; set; }

    /// <summary>Gets or sets whether the installation record is disabled.</summary>
