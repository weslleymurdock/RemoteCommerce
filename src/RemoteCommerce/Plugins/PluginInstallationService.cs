...
/// <summary>Coordinates validated plugin installation and update operations.</summary>
/// <param name="db">The scoped persistence context shared with the MediatR transaction.</param>
...
public sealed class PluginInstallationService(CommerceDbContext db, PluginPackageInstaller packageInstaller, IPluginPackageValidator packageValidator, PluginDependencyValidator dependencyValidator, IPluginPackageSource packageSource, IApplicationRestartService restartService)
{
    ...
    public Task<PluginPackageValidationResult> ValidatePackageAsync(string packagePath, CancellationToken cancellationToken = default) => packageValidator.ValidateAsync(packagePath, cancellationToken);
