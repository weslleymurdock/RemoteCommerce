...
public interface IJwtTokenService
{
    ...
    /// <param name="user">The application-level identity data.</param>
    ...
    JwtAuthenticationResult CreateToken(JwtUserDescriptor user, IEnumerable<string> roles, IEnumerable<Claim> claims);
...
/// <summary>Contains the application-level identity data required to issue JWT tokens.</summary>
/// <param name="UserId">The identity identifier.</param>
...
public sealed record JwtUserDescriptor(Guid UserId, string Email, string DisplayName, string SecurityStamp);
...
public sealed record JwtAuthenticationResult(string AccessToken, string RefreshToken, DateTimeOffset ExpiresAt, DateTimeOffset RefreshTokenExpiresAt);
