...
/// <summary>Requests a password reset message.</summary>
/// <param name="Email">The email address.</param>
...
/// <summary>Requests another confirmation message.</summary>
/// <param name="Email">The email address.</param>
...
/// <param name="RefreshToken">The refresh token issued with the authenticated session.</param>
public sealed record RefreshTokenCommand(string RefreshToken) : ICommand<JwtAuthenticationResult>;

/// <summary>Completes an authenticator-code challenge.</summary>
/// <param name="Email">The challenged email.</param>
...
/// <summary>Sets two-factor authentication state.</summary>
/// <param name="Enable">Whether two-factor authentication should be enabled.</param>
...
/// <summary>Contains two-factor configuration safe for the browser.</summary>
/// <param name="IsEnabled">Whether 2FA is enabled.</param>
/// <param name="SharedKey">The authenticator key.</param>
/// <param name="AuthenticatorUri">The provisioning URI.</param>
public sealed record TwoFactorInfo(bool IsEnabled, string? SharedKey, string? AuthenticatorUri);

/// <summary>Contains the authenticated profile.</summary>
/// <param name="Id">The user identifier.</param>
/// <param name="Email">The email address.</param>
/// <param name="DisplayName">The display name.</param>
/// <param name="EmailConfirmed">Whether the email is confirmed.</param>
/// <param name="TwoFactorEnabled">Whether 2FA is enabled.</param>
