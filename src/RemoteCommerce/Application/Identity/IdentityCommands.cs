...
public sealed class LoginCommandHandler(
    ...
    IAuditLogService auditLog) : IRequestHandler<LoginCommand, LoginResult>
{
...
public sealed class BootstrapAdministratorCommandHandler(
    ...
    IAuditLogService auditLog) : IRequestHandler<BootstrapAdministratorCommand, BootstrapAdministratorResult>
{
    ...
    public async Task<BootstrapAdministratorResult> Handle(BootstrapAdministratorCommand request, CancellationToken cancellationToken)
    {
        ...
        EnsureSucceeded(createResult, "Administrator creation failed.");
...
public sealed class LogoutCommandHandler(
    ...
    IApplicationContext applicationContext) : IRequestHandler<LogoutCommand, Unit>
{
...
public sealed class CreateUserCommandHandler(
    UserManager<ApplicationUser> userManager,
    IAuditLogService auditLog,
    IApplicationContext applicationContext) : IRequestHandler<CreateUserCommand, Guid>
{
...
public sealed class CreateRoleCommandHandler(
    RoleManager<ApplicationRole> roleManager,
    IAuditLogService auditLog,
    IApplicationContext applicationContext) : IRequestHandler<CreateRoleCommand, Guid>
{
