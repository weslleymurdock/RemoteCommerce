    ...
    string? ErrorMessage = null)
{
    ...
    public static Result Failure(int statusCode, string errorCode, string errorMessage) => new(false, statusCode, errorCode, errorMessage);
}
    ...
    string? ErrorMessage = null)
{
    ...
    /// <summary>Creates an unsuccessful result.</summary>
    public static Result<T> Failure(int statusCode, string errorCode, string errorMessage) => new(false, default, statusCode, errorCode, errorMessage);
}
