...
public interface IThemeProvider { /// <summary>Gets the currently resolved theme.</summary> ThemeDefinition Current { get; } }
...
public interface IMenuContributor { /// <summary>Gets menu contributions supplied by the contributor.</summary> IReadOnlyList<MenuItemDefinition> GetItems(); }
...
{
    /// <inheritdoc />
    public IReadOnlyList<MenuItemDefinition> GetItems() => [new("dashboard", null, "Admin.Dashboard", "Dashboard", "/admin", 0), new("catalog", null, "Catalog.Title", "ShoppingBag", "/admin/catalog/products", 10), new("catalog.products", "catalog", "Catalog.Products", "Inventory2", "/admin/catalog/products", 11), new("catalog.categories", "catalog", "Catalog.Categories", "Category", "/admin/catalog/categories", 12), new("catalog.brands", "catalog", "Catalog.Brands", "BrandingWatermark", "/admin/catalog/brands", 13), new("catalog.tags", "catalog", "Catalog.Tags", "Sell", "/admin/catalog/tags", 14), new("catalog.attributes", "catalog", "Catalog.Attributes", "Tune", "/admin/catalog/attributes", 15), new("settings", null, "Admin.Settings", "Settings", "/admin/settings", 50), new("plugins", null, "Admin.Plugins", "Extension", "/admin/plugins", 60)];
}
