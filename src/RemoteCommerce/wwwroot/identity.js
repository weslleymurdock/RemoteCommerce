window.remoteCommerceIdentity = {
    ...
    async register(email, displayName, password) { return await this.post('/api/rc/v1/identity/register', { email, displayName, password }); },
    ...
    async twoFactor() { return await this.get('/api/rc/v1/identity/manage/2fa'); },
    async setTwoFactor(enable) { return await this.post('/api/rc/v1/identity/manage/2fa', { enable }); },
